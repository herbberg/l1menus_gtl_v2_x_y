...
-- Third stage: conditions and algos
    ...
    cond_quad_eg_ov_rm_i11_i: entity work.combinatorial_conditions_ovrm
        generic map(
        ...
        port map(
            ...
            dr_ovrm => comp_dr_eg_tau_bx_0_bx_m1_0x00000000000000_0x0000000000a028,
            cond_o => quad_eg_ov_rm_i11
        );
