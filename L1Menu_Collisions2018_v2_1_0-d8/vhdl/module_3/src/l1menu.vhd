...
-- Third stage: conditions and algos
    ...
    cond_single_eg_i133_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_0038_eta_00dd_0022_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000f,
            cond_o => single_eg_i133
        );
    cond_single_eg_i135_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_0048_eta_00c6_0039_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000f,
            cond_o => single_eg_i135
        );
    cond_single_eg_i139_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_005a_eta_00c6_0039_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000f,
            cond_o => single_eg_i139
        );
    cond_single_eg_i152_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_0030_eta_00dd_0022_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000a,
            cond_o => single_eg_i152
        );
    cond_single_eg_i153_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_0034_eta_00c6_0039_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000a,
            cond_o => single_eg_i153
        );
    cond_single_eg_i161_i: entity work.combinatorial_conditions
        generic map(
            N_EG_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_eg_bx_0_pt_003c_eta_00c6_0039_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000a,
            cond_o => single_eg_i161
        );
    cond_single_jet_i233_i: entity work.combinatorial_conditions
        generic map(
            N_JET_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
        ...
        port map(
            ...
            comb_1 =>
            comb_jet_bx_0_pt_00f0_eta_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000f,
            cond_o => single_jet_i233
        );
    cond_single_jet_i274_i: entity work.combinatorial_conditions
        generic map(
            N_JET_OBJECTS, 1,
            ((0,11), (0,0), (0,0), (0,0)),
            false
    ...
    cond_calo_calo_correlation_i114_i: entity work.correlation_conditions
        ...
        port map(
            ...
            cond_o => calo_calo_correlation_i114
        );
    ...
    cond_calo_muon_correlation_i113_i: entity work.correlation_conditions
        ...
        port map(
            ...
            cond_o => calo_muon_correlation_i113
        );
