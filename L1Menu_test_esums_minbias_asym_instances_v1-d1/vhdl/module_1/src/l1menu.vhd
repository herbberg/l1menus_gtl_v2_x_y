...
-- Comparators outputs
    ...
    signal comp_count_asymethf_bx_0_0x0032 : asymethf_obj_t;
...
-- Conditions inputs
   ...
   signal comb_asymethf_bx_0_count_0032 : asymethf_obj_t;
...
-- Second stage: comparisons
    ...
    comp_count_asymethf_bx_0_0x0032_i: entity work.comparators_obj_cuts
        generic map(
            N_ASYMETHF_OBJECTS, ASYMETHF_WIDTH,
            GE, X"0032", X"0000", X"0000", "ign"
        )
        port map(
            lhc_clk, data.asymethf(bx(0)).count, comp_count_asymethf_bx_0_0x0032
        );
...
-- Third stage: conditions and algos
    ...
    comb_asymethf_bx_0_count_0032 <= 
    comp_count_asymethf_bx_0_0x0032;
    ...
    single_asymethf_i45 <=
        comb_asymethf_bx_0_count_0032(0);
    single_etmhf_i33 <= 
