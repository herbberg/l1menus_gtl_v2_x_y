...
-- Correlation cuts
    ...
    signal comp_tbpt_jet_jet_bx_m2_bx_m1_0x00000253734d80 : jet_jet_t;
...
-- First stage: calculations
    ...
    calc_twobody_pt_jet_jet_bx_m2_bx_m1_i: entity work.twobody_pt
        ...
        port map(
            conv.jet(bx(-2)).pt_vector,
            conv.jet(bx(-1)).pt_vector,
            conv.jet(bx(-2)).cos_phi,
            conv.jet(bx(-1)).cos_phi,
            conv.jet(bx(-2)).sin_phi,
            conv.jet(bx(-1)).sin_phi,
            tbpt_jet_jet(bx(-2),bx(-1))
       );
...
-- Second stage: comparisons
    ...
    comp_tbpt_jet_jet_bx_m2_bx_m1_0x00000253734d80_i: entity work.comparators_corr_cuts
        ...
        port map(
            lhc_clk, 
            tbpt_jet_jet(bx(-2),bx(-1)), comp_tbpt_jet_jet_bx_m2_bx_m1_0x00000253734d80
        );
