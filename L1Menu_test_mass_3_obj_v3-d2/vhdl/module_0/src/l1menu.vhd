...
-- 1020d034-afce-4a53-99cd-ea401741aa54
...
-- ********************************************************
-- inserted calc_sum_mass_xxx_i for test (less resources ?) manualy
-- ********************************************************
...
-- First stage: calculations
    ...
    calc_sum_mass_eg_bx_0_i: entity work.sum_mass_3_obj
        generic map(
            N_EG_OBJECTS, (EG_PT_VECTOR_WIDTH+EG_PT_VECTOR_WIDTH+EG_EG_COSH_COS_VECTOR_WIDTH)
        )
        port map(
            invmass_eg_eg(bx(0),bx(0)),
    ...
    calc_sum_mass_jet_bx_0_i: entity work.sum_mass_3_obj
        generic map(
            N_JET_OBJECTS, (JET_PT_VECTOR_WIDTH+JET_PT_VECTOR_WIDTH+JET_JET_COSH_COS_VECTOR_WIDTH)
        )
        port map(
            invmass_jet_jet(bx(0),bx(0)),
    ...
    calc_sum_mass_mu_bx_0_i: entity work.sum_mass_3_obj
        generic map(
            N_MU_OBJECTS, (MU_PT_VECTOR_WIDTH+MU_PT_VECTOR_WIDTH+MU_MU_COSH_COS_VECTOR_WIDTH)
        )
        port map(
            invmass_mu_mu(bx(0),bx(0)),
...
-- Second stage: comparisons
    ...
    comp_inv_mass_3_obj_jet_bx_0_0x00000000256250_0x00000000f73140_i: entity work.comparators_mass_3_obj
        generic map(
            N_EG_OBJECTS,(JET_PT_VECTOR_WIDTH+JET_PT_VECTOR_WIDTH+JET_JET_COSH_COS_VECTOR_WIDTH), mass, 
            X"00000000256250", X"00000000F73140"        
        )
        port map(
    ...
    comp_inv_mass_3_obj_eg_bx_0_0x00000007735940_0x0000001dcd6500_i: entity work.comparators_mass_3_obj
        generic map(
            N_EG_OBJECTS,(EG_PT_VECTOR_WIDTH+EG_PT_VECTOR_WIDTH+EG_EG_COSH_COS_VECTOR_WIDTH), mass, 
    ...
    comp_inv_mass_3_obj_mu_bx_0_0x0000004a817c80_0x0000012a05f200_i: entity work.comparators_mass_3_obj
        generic map(
            N_MU_OBJECTS, (MU_PT_VECTOR_WIDTH+MU_PT_VECTOR_WIDTH+MU_MU_COSH_COS_VECTOR_WIDTH), mass, 
