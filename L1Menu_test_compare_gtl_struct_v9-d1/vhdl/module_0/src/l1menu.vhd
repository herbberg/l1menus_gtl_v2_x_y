...
-- Correlation cuts
    ...
    signal comp_tbpt_tau_tau_bx_m1_bx_m2_0x00000253734d80 : tau_tau_t;
...
-- First stage: calculations
    ...
    calc_twobody_pt_tau_tau_bx_m1_bx_m2_i: entity work.twobody_pt
        generic map(
        ...
        port map(
            conv.tau(bx(-1)).pt_vector,
            conv.tau(bx(-2)).pt_vector,
            conv.tau(bx(-1)).cos_phi,
            conv.tau(bx(-2)).cos_phi,
            conv.tau(bx(-1)).sin_phi,
            conv.tau(bx(-2)).sin_phi,
            tbpt_tau_tau(bx(-1),bx(-2))
       );
...
-- Second stage: comparisons
    ...
    comp_tbpt_tau_tau_bx_m1_bx_m2_0x00000253734d80_i: entity work.comparators_corr_cuts
        ...
        port map(
            lhc_clk, 
            tbpt_tau_tau(bx(-1),bx(-2)), comp_tbpt_tau_tau_bx_m1_bx_m2_0x00000253734d80
        );
...
-- Third stage: conditions and algos
    ...
    cond_transverse_mass_i4_i: entity work.correlation_conditions
        generic map(
    ...
    cond_calo_calo_correlation_ov_rm_i27_i: entity work.correlation_conditions_ovrm
        ...
        port map(
            ...
            tbpt => comp_tbpt_tau_tau_bx_m1_bx_m2_0x00000253734d80, 
