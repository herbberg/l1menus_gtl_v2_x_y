...
-- Correlation cuts
    ...
    signal comp_tbpt_eg_eg_bx_m1_bx_p1_0x00000253734d80_0x00000253734d80 : eg_eg_t;
...
-- Second stage: comparisons
    ...
    comp_tbpt_eg_eg_bx_m1_bx_p1_0x00000253734d80_i: entity work.comparators_corr_cuts
        ...
        port map(
            lhc_clk, 
            tbpt_eg_eg(bx(-1),bx(1)), comp_tbpt_eg_eg_bx_m1_bx_p1_0x00000253734d80_0x00000253734d80
        );
...
-- Third stage: conditions and algos
    ...
    cond_invariant_mass_ov_rm_i6_i: entity work.correlation_conditions_ovrm
        ...
        port map(
            ...
            tbpt => comp_tbpt_eg_eg_bx_m1_bx_p1_0x00000253734d80_0x00000253734d80, 
