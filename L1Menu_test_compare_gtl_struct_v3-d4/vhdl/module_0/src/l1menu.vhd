...
-- Comparators outputs
    ...
    signal pt_mu_1 : mu_obj_t;
    signal pt_mu_2 : mu_obj_t;
    signal qual_mu_1 : mu_obj_t;
    signal qual_mu_2 : mu_obj_t;
    signal qual_mu_3 : mu_obj_t;
...
-- Conditions inputs
    ...
    signal comb_mu_1 : mu_obj_t;
    signal comb_mu_2 : mu_obj_t;
    signal comb_mu_3 : mu_obj_t;
...
-- First stage: calculations
    ...
    calc_2_i: entity work.deta_calc
        generic map(
    ...
    calc_4_i: entity work.dphi_calc
        generic map(
            N_EG_OBJECTS, N_JET_OBJECTS, (eg_t,jet_t),
    ...
    calc_7_i: entity work.deta_calc
        generic map(
    ...
    calc_9_i: entity work.dphi_calc
        generic map(
            N_JET_OBJECTS, N_JET_OBJECTS, (jet_t,jet_t),
    ...
    calc_12_i: entity work.deta_lut
        generic map(
            N_JET_OBJECTS, N_JET_OBJECTS, (jet_t,jet_t)
        )
        port map(
    ...
    calc_13_i: entity work.deta_calc
        generic map(
    ...
    calc_14_i: entity work.dphi_calc
        generic map(
            N_JET_OBJECTS, N_TAU_OBJECTS, (jet_t,tau_t),
    ...
    calc_15_i: entity work.deta_calc
        generic map(
    ...
    calc_16_i: entity work.dphi_calc
        generic map(
            N_JET_OBJECTS, N_MU_OBJECTS, (jet_t,mu_t),
    ...
    calc_17_i: entity work.deta_lut
        generic map(
            N_JET_OBJECTS, N_TAU_OBJECTS, (jet_t,tau_t)
        )
        port map(
    ...
    calc_18_i: entity work.dphi_lut
        generic map(
            N_JET_OBJECTS, N_TAU_OBJECTS, (jet_t,tau_t)
        )
        port map(
    ...
    calc_19_i: entity work.deta_lut
        generic map(
            N_JET_OBJECTS, N_MU_OBJECTS, (jet_t,mu_t)
        )
        port map(
    ...
    calc_20_i: entity work.dphi_lut
        generic map(
            N_JET_OBJECTS, N_MU_OBJECTS, (jet_t,mu_t)
        )
        port map(
...
-- 
    ...
    comp_6_i: entity work.comparators_obj_cuts
        ...
        port map(
            lhc_clk, data.mu(bx(0)).pt, pt_mu_1
        );
    ...
    comp_110_i: entity work.comparators_obj_cuts
        ...
        port map(
            lhc_clk, data.mu(bx(0)).pt, pt_mu_2
        );
    ...
    comp_7_i: entity work.comparators_obj_cuts
        ...
        port map(
            lhc_clk, data.mu(bx(0)).qual, qual_mu_2
        );
    ...
    comp_8_i: entity work.comparators_obj_cuts
        ...
        port map(
            lhc_clk, data.mu(bx(0)).qual, qual_mu_1
        );
    ...
    comp_111_i: entity work.comparators_obj_cuts
        ...
        port map(
            lhc_clk, data.mu(bx(0)).qual, qual_mu_3
        );
    ...
    comp_112_i: entity work.comparators_corr_cuts
        ...
        port map(
            lhc_clk, dr_jet_mu(bx(0),bx(0)), dr_jet_mu_1
        );
...
-- Third stage: conditions and algos
    ...
    comb_mu_1 <= pt_mu_1 and qual_mu_2;
    comb_mu_2 <= pt_mu_1 and qual_mu_1;
    comb_mu_3 <= pt_mu_2 and qual_mu_3;
