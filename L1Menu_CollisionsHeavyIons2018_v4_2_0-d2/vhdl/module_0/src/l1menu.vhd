...
-- Third stage: conditions and algos
    ...
    cond_calo_calo_correlation_i163_i: entity work.correlation_conditions
        ...
        port map(
            ...
            comb_jet_bx_0_pt_0038_eta_00c2_003d_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000f, 
            delta_r => comp_dr_eg_jet_bx_0_bx_0_0x00000000027100_0x000000084ca240,
            cond_o => calo_calo_correlation_i163
        );
    ...
    cond_muon_muon_correlation_i116_i: entity work.correlation_conditions
        ...
        port map(
            ...
            cond_o => muon_muon_correlation_i116
        );
...
-- 238 L1_DoubleMuOpen_MaxDr2p0_BptxAND : dist{MU0[MU-QLTY_OPEN],MU0[MU-QLTY_OPEN]}[DR_MAX2p0] AND EXT_ZeroBias_BPTX_AND_VME
    ...
    algo(5) <= l1_double_mu_open_max_dr2p0_bptx_and;
...
-- 394 L1_SingleEG15_SingleJet56_MidEta2p7_MinDr0p4_BptxAND : dist{EG15,JET56[JET-ETA_2p7]}[DR_MIN_0p4] AND EXT_ZeroBias_BPTX_AND_VME
    ...
    algo(4) <= l1_single_eg15_single_jet56_mid_eta2p7_min_dr0p4_bptx_and;
