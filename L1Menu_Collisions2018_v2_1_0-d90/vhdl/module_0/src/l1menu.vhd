...
-- Correlation cuts
    ...
    signal comp_invmass_tau_tau_bx_0_bx_0_0x0000000000000_0x000001312d000 : tau_tau_t;
...
-- Second stage: comparisons
    ...
    comp_invmass_tau_tau_bx_0_bx_0_0x0000000000000_0x000001312d000_i: entity work.comparators_corr_cuts
        generic map(
            N_TAU_OBJECTS, N_TAU_OBJECTS, (tau_t,tau_t),
            TAU_TAU_MASS_VECTOR_WIDTH, mass, 
            X"0000000000000", X"000001312D000"        
        )
        port map(
            lhc_clk, 
            invmass_tau_tau(bx(0),bx(0)), comp_invmass_tau_tau_bx_0_bx_0_0x0000000000000_0x000001312D000
        );
...
-- Third stage: conditions and algos
    ...
    and comp_eta_jet_bx_0_0x00c9_0x0036
    ;
    ...
    and comp_eta_mu_bx_0_0x017f_0x0081
    ...
    comp_pt_mu_bx_0_0x0001
    and comp_eta_mu_bx_0_0x019b_0x0065
    and comp_qual_mu_bx_0_0xfff0
    ;
    ...
    cond_invariant_mass_i359_i: entity work.correlation_conditions
        ...
        port map(
            ...
            in_2 => 
            comb_tau_bx_0_pt_003c_eta_00cf_0030_0000_0000_0000_0000_0000_0000_0000_0000_phi_0000_0000_0000_0000_iso_000e, 
            inv_mass => comp_invmass_tau_tau_bx_0_bx_0_0x0000000000000_0x000001312d000,
...
-- 282 L1_Mu22er2p1_IsoTau28er2p1 : MU22[MU-QLTY_SNGL,MU-ETA_2p10] AND TAU28[TAU-ETA_2p13,TAU-ISO_0xE]
    ...
    algo(43) <= l1_mu22er2p1_iso_tau28er2p1;
...
-- 293 L1_IsoTau40er2p1_ETMHF100 : TAU40[TAU-ETA_2p13,TAU-ISO_0xE] AND ETMHF100
    ...
    algo(25) <= l1_iso_tau40er2p1_etmhf100;
